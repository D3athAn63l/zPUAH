...
static class HarmonyPatches
{
    ...
    {
        var harmony = new Harmony("mehni.rimworld.pickupandhaul.optimized");
#if DEBUG
        Harmony.DEBUG = true;
#endif
    ...
    public static bool SkipCorpses_Prefix(WorkGiver_Haul __instance, ref bool __result, Pawn pawn)
    {
        ...
        if (Settings.AllowCorpses
            || pawn.Map.listerThings.ThingsInGroup(ThingRequestGroup.Corpse).Count < 1)
        {
            __result = true;
            return false;
        }
